...
/** A symbolic representation of an [[fr.paulblouet.criojomin.Atom]], as used in rule premises and "where" guards.<br />
  ...
  * an AtomN ([[fr.paulblouet.criojomin.Atom0]], [[fr.paulblouet.criojomin.Atom1]], etc) that
...
/** An atom identifier, which can create [[fr.paulblouet.criojomin.AtomPattern]]s and
  * [[fr.paulblouet.criojomin.AtomInstance]]s.<br />
  * Its implementations are arity dependent: [[fr.paulblouet.criojomin.Atom0]] to (currently)
  * [[fr.paulblouet.criojomin.Atom2]] (will expand to Atom22, to match `scala.Product`).
  *
